...
//import com.smile.taobaodemo.bean.PickerCityAddressBean;
//import com.smile.taobaodemo.widget.ClearEditText;
//import com.smile.taobaodemo.widget.EnjoyshopToolBar;
//
...
//                    ToastUtils.show(AddressAddActivity.this, "数据获取失败,请重试");
//                    break;
//
//            }
//        }
...
//                    ShowPickerView();
//                } else {
//                    ToastUtils.show(AddressAddActivity.this, "请稍等,数据获取中");
//                }
//                break;
//        }
//    }
...
//            ToastUtils.show(AddressAddActivity.this, "收件人为空,请检查");
//            return;
//        }
//
//        if (TextUtils.isEmpty(phone)) {
//            ToastUtils.show(AddressAddActivity.this, "联系电话为空,请检查");
//            return;
//        }
//
//        if (TextUtils.isEmpty(smallAddress) || TextUtils.isEmpty(bigAddress)) {
//            ToastUtils.show(AddressAddActivity.this, "地址不完整,请检查");
//            return;
//        }
//
//        String userId = Constant.USER.getObjectId();
//
//        List<Address> mAddressDataList = null;//此处获取列表数据
...
//            ToastUtils.show(AddressAddActivity.this, "地址添加成功");
...
//            ToastUtils.show(AddressAddActivity.this, "地址修改成功");
//        }
//
//        finish();
//
