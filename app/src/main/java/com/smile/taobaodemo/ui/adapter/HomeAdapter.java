...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {//添加首页条目
        ...
        if (viewHolder instanceof CarouselHolder) {
            ...
            GlideUtil.load(activity, bean.getUrl(), holder.ivHome);
            holder.tvTitle.setText(bean.getName());
            holder.tvPrice.setText(String.format("%s%s起", bean.getCurrency(), bean.getPrice()));
        ...
        RecommendHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Log.d("OnClick", "onClick: 成功点击"+getLayoutPosition());
                    if (listener != null)
